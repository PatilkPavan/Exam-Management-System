  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h3 style="color:#202020; font-family:'typo' ;font-size:4vw" class="title1"></h4>
		<h3 style="font-family:'typo' ">Pavan  Patil </h3>
		<h3 style="font-family:'typo' ">subhuangi tekwade </h3>
		<h3 style="font-family:'typo' ">subhuangi phapde </h3>
		<h3 style="font-family:'typo' ">Pooja suryanshi </h3>
		</h4></div></div>
		</p>
      </div>
